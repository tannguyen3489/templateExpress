  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function maxOptionsText(numAll, numGroup) {
        return [numAll == 1 ? 'Limit je postignut ({n} stvar maximalno)' : 'Limit je postignut ({n} stavke maksimalno)', numGroup == 1 ? 'Grupni limit je postignut ({n} stvar maksimalno)' : 'Grupni limit je postignut ({n} stavke maksimalno)'];
      },
...
//# sourceMappingURL=defaults-cro_CRO-compiled.js.map
  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function maxOptionsText(numAll, numGroup) {
        return [numAll == 1 ? 'Grense nådd (maks {n} valg)' : 'Grense nådd (maks {n} valg)', numGroup == 1 ? 'Grense for grupper nådd (maks {n} grupper)' : 'Grense for grupper nådd (maks {n} grupper)'];
      },
...
//# sourceMappingURL=defaults-nb_NO-compiled.js.map
  ...
  (function ($) {
    $.fn.selectpicker.defaults = {
      ...
      maxOptionsText: function maxOptionsText(numAll, numGroup) {
        return [numAll == 1 ? 'Begrænsning nået (max {n} valgt)' : 'Begrænsning nået (max {n} valgte)', numGroup == 1 ? 'Gruppe-begrænsning nået (max {n} valgt)' : 'Gruppe-begrænsning nået (max {n} valgte)'];
      },
...
//# sourceMappingURL=defaults-da_DK-compiled.js.map